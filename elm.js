...
Elm.ComputationalGeometry.make = function (_elm) {
   "use strict";
   _elm.ComputationalGeometry = _elm.ComputationalGeometry || {};
   if (_elm.ComputationalGeometry.values)
   return _elm.ComputationalGeometry.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "ComputationalGeometry",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
...
Elm.PointInTriangle.make = function (_elm) {
   "use strict";
   _elm.PointInTriangle = _elm.PointInTriangle || {};
   if (_elm.PointInTriangle.values)
   return _elm.PointInTriangle.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var pointInTriangleString = function (coords) {
      return function () {
         ...
         return function () {
            switch (coords.ctor)
            {case "::":
               switch (coords._1.ctor)
                 {case "::":
                    switch (coords._1._1.ctor)
                      {case "::":
                         switch (coords._1._1._1.ctor)
                           {case "::":
                              return A4(inTriangle,
                                coords._1._0,
                                coords._1._1._0,
                                coords._1._1._1._0,
                                coords._0) ? $Maybe.Just("Point is in triangle") : $Maybe.Just("Point is not in triangle");}
                           break;}
                      break;}
                 break;}
            return $Maybe.Nothing;
   ...
   var coordPairs = function (coords) {
      return function () {
         var triangleCoords = $List.take(3)($List.reverse(coords));
         return function () {
            switch (triangleCoords.ctor)
            {case "::":
               return A3($List.map2,
                 F2(function (v0,v1) {
                    return {ctor: "_Tuple2"
                 ...
                 A2($Basics._op["++"],
                 triangleCoords._1,
                 _L.fromArray([triangleCoords._0])));}
            return _L.fromArray([]);
         }();
      }();
   };
   ...
   _elm.PointInTriangle.values = {_op: _op
                                 ...
                                 ,lines: lines
                                 ,pointInTriangleString: pointInTriangleString
                                 ,drawToCanvas: drawToCanvas
                                 ,main: main};
   return _elm.PointInTriangle.values;
};
Elm.RadialSort = Elm.RadialSort || {};
Elm.RadialSort.make = function (_elm) {
   "use strict";
   _elm.RadialSort = _elm.RadialSort || {};
   if (_elm.RadialSort.values)
